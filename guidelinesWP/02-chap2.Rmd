...
<!--CH include  fromNHQ:
refer to more nuanced definition of serious harm, expanded on in intro
sub-principles from Marentette:
...
CH: this idea of 'feasible to calculate' came from Julie's recap at the TESA workshop where she mentioned how participants interpeted 'operational'. I'd prefer to leave in for now, but can take out in a later draft.
-->

<!--CH consider Marentte et al: 
...
**Principle 6**. Consider the use of alternative paradigms for developing LRPs. LRP estimates that converge when derived using different approaches, increases support that the methods capture underlying population dynamics despite differing assumptions and use of available data.  However, if LRPs cannot be estimated reliably using one method or approach, then consider alternatives approaches based on different sets of assumptions and/or data. 
