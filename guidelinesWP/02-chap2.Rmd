...
Fourth, estimate of LRPs should be estimated in a statistically integrated <!-- 
  CW: or sequential Bayes? i.e. sampling from posterior--> way when possible in order to propagate uncertainties throughout analyses and to be consistent with current best-practices in fisheries assessments [@puntEssentialFeaturesNextgeneration2020a]. @statonSequentialIntegratedBayesian2017 and @defilippoImprovingShorttermRecruitment2021 provide recent examples of integrated models used for salmon assessments. Both studies show that uncertainty propagation increase realism of model estimates and surrounding uncertainty. However, statonSequentialIntegratedBayesian2017a demonstrated that similar results can be achieved by using sequential Bayesian estimation models. 
