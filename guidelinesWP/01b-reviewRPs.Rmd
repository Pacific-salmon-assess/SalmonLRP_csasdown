...
\item Under Canada's WSP, a composite of metrics ('multidimensional approach') is used in status assessments, including metrics on current spawner abundances, short and long-term trends in abundances, and the distribution of spawning, among others.
...
\item In some cases, single-metric approaches in which spawner abundances are compared with an abundance-based benchmark have been used as proxies for status under the WSP.
\end{itemize}
\end{tcolorbox}
...
\begin{itemize}
\item triggering rebuilding plans under the Fish Stocks provisions,
