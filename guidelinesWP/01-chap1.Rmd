...
In terms of salmonids, @portleyLimitReferencePoints2014 reviews the use of limit reference points (or their absence) for Pacific salmon stocks in the U.S. (Alaska and Pacific Northwest), Canada, Russia, and Japan. They highlight the role of LRPs in allowing for cross-jurisdictional comparisons of sustainability. In Canada, @chaputConsiderationsDefiningReference2012 reviewed the use of reference points, including LRPs, in the management of salmonids and other semelparous species. This review is focused on the stock/Conservation Unit (CU) level applications of LRPs and provides a comprehensive overview of the different methods available to assess CU status and their historical applications. It also provides considerations on managing multiple stock fisheries or managing multiple stocks as unit, it highlights that mixed stock management requires more precautionary benchmarks to ensure that all stocks remain above their limit reference points. Previous work and guidance on setting LRPs for pacific salmon focused on management at the CU level. The present work expands on the previous work by providing guidance on setting LRPs for management at the SMU level, i.e. a group of CUs, taking into consideration the need to maintain all CUs within an SMU above their limit reference points. 
