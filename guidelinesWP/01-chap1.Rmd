...
```{r DiversitySchematic, fig.cap="Schematic representation of hierarchical population structure of Pacific salmon (left) with the spatial scales of a selection of uses and management activities alighed with those scales, including the scale of Stock Management Units, SMUs (right)", out.width = '60%', warning=FALSE, echo=FALSE, fig.align="center"}
