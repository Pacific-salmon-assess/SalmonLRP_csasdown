...
<!--KH: I agree that getting into the challenges in identifying buffers may be too specific for this introductory section.  Maybe you could get around the above question on buffers by using the word intended; eg "The lower benchmark, delineating the red and amber zones, is intended to be set at a level that "ensures there is ..... "-->
