...
-  
The identification and use of LRPs in the management of many of Canada's marine fisheries predates the royal assent of the revised fisheries act. Previous DFO policy documents such as the "Harvest Decision-Making Framework Incorporating the Precautionary Approach" (citation) and "Canada's Policy for conservation of Wild Pacific Salmon" already required the establishment of lower management benchmarks to prevent serious harm to managed populations. In compliance with these policies LRPs have been implemented in various marine fisheries across Canada, examples include Pacific Herring [@kronlundSelectionRoleLimit2018], snow crab [@mullowneyBasisPrecautionaryApproach2018], cite a salmon example ? sockeye?
search other DFO LRP work. 
