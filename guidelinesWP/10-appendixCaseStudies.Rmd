...
Two of the three CUs in this SMU, WCVI-South and WCVI-Nootka and Kyuquot, were assessed as Red status in a recent integrated Wild Salmon Policy assessment [@dfoIntegratedBiologicalStatus2016].  WCVI Chinook was identified as a stock of concern in the 2021 Integrated Fisheries Management Plan (IFMP) and a rebuilding plan is under development [@dfoPacificRegionFinal2021]. Poor smolt-to-age-2 survival for WCVI Chinook and low spawner levels over the past two decades were highlighted as reasons for conservation concern in the IFMP [@dfoPacificRegionFinal2021]. 
