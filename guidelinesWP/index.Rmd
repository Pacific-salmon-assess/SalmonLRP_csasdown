...
author: |
  ...
  Catarina Wor^1^ 
  Connors, Brendan ^2^ 
  Huang, Ann-Marie ^3^ and
  others (TBD)
author_list: "Holt, C.A., Holt, K., Warkentin, L., Wor, C. and others(TBD)"
address: |
...
citation_other_language: "Holt, C.A., Holt, K., Warkentin, L., et autres. Guidelines for Defining Limit Reference Points for Pacific Salmon Stock Management Units. DFO Secr. can. de consult. sci. du MPO. Doc. de rech 2021/nnn. iv + 13 p."
abstract: |
