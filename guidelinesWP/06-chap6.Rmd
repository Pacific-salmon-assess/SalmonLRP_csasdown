...
\subsection*{Key Points:}
\begin{itemize} 
\item For \textbf{proportional LRPs} when an SMU contains data-deficient CUs and the remaining data-rich CUs are above Red Status, we recommend SMU status be either provisional or data deficient.
\begin{itemize}
...
\end{itemize}
\item Also for \textbf{proportional LRPs}, when any component CU has Red status, we recommend SMU status be assessed as below the LRP regardless of the presence of data-deficient CUs and whether the status data-deficient CUs can be inferred from data-rich CUs.
