...
\subsection*{Key Points:}
\begin{itemize} 
\item For \textbf{CU status-based LRPs} when an SMU contains data-deficient CUs and the remaining data-rich CUs are above Red Status, we recommend SMU status be either provisional or data deficient.
\begin{itemize}
