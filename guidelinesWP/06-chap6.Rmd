...
In addition, the distribution of spawning within CUs is a component of CU assessments under the WSP, but robust metrics and benchmarks of distribution are lacking. Future research on assessment methods that more rigorosly considering population structure within CUs would benefit both CU assessments under the WSP and assessments relevant to First Nations who often rely on salmon populations at relatively fine spatial scales. 
