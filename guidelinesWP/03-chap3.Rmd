...
<!-- CW: One could also quantify uncertainty based in a 95% Bayesian credibility interval. Suggest replacing the above sentence with:

Uncertainty in logistic-regression based LRP estimates can be quantified based on confidence or creibility intervals on the LRP estimate (see our application to Interior Fraser Coho Salmon (Holt et al. in review)).
