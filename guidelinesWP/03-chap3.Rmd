...
# Approaches for Setting Aggregate Abundance LRPs Based on CU Status {#approaches}

In this guidance document, we focus on providing guidance for the two aggregate abundance methods (Data-based and projected LRPs).  Here, we provide a more detailed description of these two methods.

## Empirical LRPs (derived from logistic regression of historical data
