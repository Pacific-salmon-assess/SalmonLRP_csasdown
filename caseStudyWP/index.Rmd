...
author: |
  ...
  Candace Picco^6^
  others (TBD)
author_list: "Holt, K., Holt, C.A., Warkentin, L., Wor, C., Davis, B., Bokvist, J., Crowley, S., Luedke, W., McHugh, D., Picco, C. and others(TBD)"
address: |
  ...
  ^2^Pacific Biological Station\
     Fisheries and Oceans Canada, 3190 Hammond Bay Rd\
     Nanaimo, British Columbia, V9T 6N7, Canada\
  ^3^Lower Fraser Area Office\
     Fisheries and Oceans Canada, 100 Annacis Pkwy Unit 3\
     Delta, British Columbia, V3M 6A2, Canada\
  ^4^Southcoast Area Office\
     Fisheries and Oceans Canada, 3225 Stephenson Point Rd\
     Nanaimo, British Columbia, V9T 1K3, Canada\
  ^5^Nuu-chah-nulth Tribal Council\
     5001 Mission Rd\
     Port Alberni, British Columbia, V9Y 8X9, Canada\
  ^6^Ha'oom Fisheries Socierty\
