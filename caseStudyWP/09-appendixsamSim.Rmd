...
The observed recruitment by brood year is then retrieved by multiplying the true recruitment at age for each brood year by the vector of observed proportions at age  (Equation \@ref(eq:obsRa)). 



\begin{align}
  obsR_{y-J,k} &= RY_{y-j,k} \cdot obsppn_{y,k,j}
  (\#eq:obsRa)
\end{align}
