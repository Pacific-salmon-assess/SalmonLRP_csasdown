...
\begin{cases}
 ...
 \dfrac{\dot{mixC}^{*}_{y,i}}{RY_{y,i}-C_{y,i,n=U.S.}} & \text{n=U.S.} \\
 \dfrac{\dot{singleC}^{*}_{y,i}}{RY_{y,i}-C_{y,i,n=U.S.}-mixC_{y,i}} & \text{n=U.S.} \\
\end{cases} 
  (\#eq:muER)
\end{align}
...
\begin{align}
  (\#eq:spawners)
  S_{y,i} &= RY_{y,i} \cdot(1-\sum^{n}ER_{y,i,n}) \\
