...
\begin{align}
  CanTAC_{y,k} &= CanER_{y,k} \cdot RYMU_{y,MU}\\ 
  USATAC_{y,k} &= USAER_{y,k} \cdot RYMU_{y,MU}
  (\#eq:tac)
\end{align}
...
The allowable catch is then calculated from  and this exploitation rate is applied to all projection years with the addition of random error following a beta distribution.

\begin{align}
  CANER_{y,k} &= \sum^{k \in MU} $RY_{y,k}\\
