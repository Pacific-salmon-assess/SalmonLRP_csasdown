...
\begin{align}
  S_{MSY} &= (1 - lambertW(e^{1-\alpha^\prime_{k}}))/\beta_{k}\\
  \alpha^\prime_{k} &= \alpha_{k} + \gamma_{k}\cdot log(Survinit_{k})
  (\#eq:smsy)
\end{align}
