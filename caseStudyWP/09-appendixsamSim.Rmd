...
$\overline{mat}_{j,i}$& average proportions of mature fish at age \\ 
$\tau_i$ & Multivariate logistic variability parameter for maturity error\\
\hline
\end{tabular}
(\#tab:paramtab)
\end{table}
...
\begin{align}
  mat_{y,i} \sim \text{Multivariate Logistic}(\overline{mat}_{j,i},\tau_{i}) \\
  (\#eq:mat)
\end{align}
