...
$\tau_{i}$ & multivariate logistic variability parameter for proportions at age\\
$\overline{Surv_{i}}$ & mean survival covariate \\
...
\begin{align}
  ...
  wSurv_{y} &\sim N(\overline{Surv_{i}},\sigma_{Surv})
  (\#eq:survCY)
\end{align}
