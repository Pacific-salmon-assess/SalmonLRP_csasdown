...
<!--CH: can you add a sentence to the results stating if status against proportion-based or logistic regression-based LRPs were sensitive to the omission of Fraser River Canyon in particular?-->
...
When estimating logistic regression LRPs using S\textsubscript{gen}, we used an integrated modelling approach in which CU-level S\textsubscript{gen} and the SMU-level LRP were simultaneously estimated. The integrated Sgen-LRP models had two components:  
