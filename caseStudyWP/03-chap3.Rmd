...
knitr::include_graphics(here::here("caseStudyWP/figure/coho-map.png"))
```
...
knitr::include_graphics(here::here("caseStudyWP/figure/coho-escapeSeries.png"))
```
...
**2) Distribution among subpopulations**
...
All four of the Sgen-LRP model options used an integrated modelling approach with two components to generate LRPs:
(i)	Stock-recruit models fit to each of the 5 CUs to estimate CU-level Sgen (using equations xxx - xxx above)
(ii)	A Bernoulli logistic regression model fit to aggregated data to estimate the LRP as the aggregate abundance that has historically been associated with all five CUs being above Sgen. 
