...
The logistic regression model fit to CU-level status predictions from the Sgen:IM Integrated LRP model in 2020 is shown in Figure \@ref(fig:coho-IM-logisticFit2020), while the resulting LRP estimates are shown in Table \@ref(tab:logisticLRPs2020). Aggregate abundance-based LRP estimates ranged from 15,395 spawners (95% CI = 11,187-19,603) when there was a required 50% probability that all CUs would be above Sgen to 24,331 spawners (95% CI = 13,924-34,738) when there was a required 99% probability that all CUs would be above Sgen (Table \@ref(tab:logisticLRPs2020)). While the Integrated Sgen:IM model was able to converge on a solution, there was considerable uncertainty around the predicted LRP curve as seen in the large area of gray shading in Figure \@ref(fig:coho-IM-logisticFit2020).

Logistic regression diagnostics indicate that high uncertainty is a result of insufficient sample size.  


+------------------------+--------------+-----------------+-----------------+
| Diagnostic Test        | Sgen: IM     | Sgen:IM.HiCap   | Distributional
+========================+==============+=================+=================+
| Box-Tidwell p-value    | 0.81         | 1.0
+------------------------+--------------+-----------------+-----------------+         
| Max. deviance residual | 1.52         | 1.68
+------------------------+--------------+-----------------+-----------------+  
| AR-1                   | -0.20        | 0.16
+------------------------+--------------+-----------------+-----------------+
| Min. sample size       | 77^*         | 26
+------------------------+--------------+-----------------+-----------------+
| Wald Test p-value      | <0.01        | <0.01
+------------------------+--------------+-----------------+-----------------+
| Quasi-R^2              | 0.68         | 0.63
+------------------------+--------------+-----------------+-----------------+
| Hit Ratio (p*= 50%,    | 0.91, 0.91   | 0.87, 0.91,     |
| 60%, 90%, 99%)         | 0.91, 0.74   | 0.87, 0.78      |
+--------------------+------------------+-----------------+------------------+
