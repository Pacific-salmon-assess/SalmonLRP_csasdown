...
<!--
CH comment: The proportion of CUs with red status was more sensitive to Ricker model formulation than to if the multi-dimensional or single metric approach was applied." Is this all true? 
KH response: I don't understand this last bit right now.
-->
...
- Data rich SMU; while the number of years of data are limited, full SR time series are available for all 5 CUs.  These have previoulsy been used to develop forward simulations for individual CUs within the SMU.
...
- The abundance-based methods we considered often matched the proportional methods in a historical comparison of SMU status relative to LRPs. For a given assumption about SR model structure, LRPs tended to be triggered in similar periods of times under the aggregate abudnance-based and proportional options; however, there were some differences.
