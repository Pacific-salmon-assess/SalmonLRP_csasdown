...
<!--This last sentence above is confusing with the full retrospective analysis presented later
...
Table: (\#tab:projectedLRPs2020) Aggregate abundance based LRPs (with 95% confidence intervals) from -------. For each probability level, the LRP estimate represents that probability that all CUs will be above their lower benchmark.
...
```{r coho-projLRPCurve-bySigGamma, fig.cap="Probability of all CUs being above their lower benchmark of Sgen along a gradient in aggregate abundances within bins of 200 fish for----. Results are derived from projections over 30 years and 20,000 MC Trials. Candidate LRPs at p=0.5 (yellow) and p=0.66 (blue), 0.90 (green), and 0.99 (orange) are highlighted. Each dot is the proportion of MC trials where all CUs were > lower benchmarks.", warning=FALSE, echo=FALSE, out.width = '50%',  fig.align="center"}
