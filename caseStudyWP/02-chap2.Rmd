...
<!-- CW comment: I think we should add a little bit  moere explanation about the rationale for the  the projection based models. something like.

The projection-based LRP approach combines all the information known for the CUs within an SMU and then uses that information to project abundance trends into the future. The objective of this approach was to evaluate how the projection trajectories respond to exploitation when calculating LRPs. This approcah allows for explicit consideration of uncertainty as the user can specify various projection scenarios to reflect ack of biological or fisheries information. 
 -->
