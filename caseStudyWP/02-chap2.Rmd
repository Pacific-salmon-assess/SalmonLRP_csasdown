...
The following steps were taken to calculate projected LRPs using samSim:
   ...
   2. For each simulated year-trial combination, characterize abundances as follows:
      ...
      * Assign aggregate SMU level spawner abundance for each year-trial combination to an abundance bin ($AggS_{bin}$), based on 200 fish intervals. E.g., $AggS_{bin}$ = 0:200 fish, 200:400 fish, 400:600 fish, ... etc.
