...
\toprule
\multicolumn{2}{l}{\parbox{5.8cm}{Multidimensional approach used in the Salmon Scanner}}& Yes (only for CU status-based LRPs) &   Yes (only for CU status-based LRPs)  &  Yes (only for CU status-based LRPs)\\
\midrule
...
\multicolumn{2}{l}{} & Interior Fraser River Coho & WCVI Chinook & Inside South Coast Chum \\
\toprule
\multicolumn{2}{l}{CU status-based LRP} &  Yes &   Yes &   Yes\\
\midrule
