...
We also maintain consistency with the WSP by only including spawning streams without significant enhancement when evaluating CU and SMU status. We use the Proportionate Natural Influence metric, PNI,as a basis for defining 'significant enhancement'. PNI is a metric of the genetic risk of hatcheries on natural populations. Values less than 0.5 indicate populations where most fish are hatchery origin [classified as integrated-hatchery populations; @withlerGeneticallyBasedTargets2018]. We defined 'significant enhancement' as PNI values < 0.5 and excluded spawning streams with PNI estimated or assumed to be < 0.5 from case study analyses. Systems with levels of PNI > 0.5 can still have hatchery influences; however, dynamics are predominately natural origin. <!--KH: suggesting removal for simplification: PNI values $\geqslant$ 0.5 and < 0.72 indicate populations where natural-origin fish predominate (integrated-transition populations), and values $\geqslant$ 0.72 indicate populations where most fish are considered 'wild' under the WSP with parents who were born in the natural environment [integrated-wild populations; @dfoCanadaPolicyConservation2005; @withlerGeneticallyBasedTargets2018]. Fully wild populations are those that not have hatchery programs, and for which strays from out-of-basin hatchery production are limited to <3% per year [@withlerGeneticallyBasedTargets2018].--> Where time-series of the proportion of hatchery marked fish on the spawning grounds are available (e.g., Interior Fraser Coho case study), these proportions are used to inform assessments in two ways: first to develop time-series of natural-origin recruitment for benchmark estimation based on stock-recruitment relationships and second to develop time series of natural-origin spawners for status assessment against benchmarks.  When reliable time-series of the proportion of hatchery influence are not available (WCVI Chinook), total spawners are used for LRP analyses provided that the threshold of assumed PNI > 0.5 has been met.     
