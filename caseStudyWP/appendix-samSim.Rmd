...
### Recruitment data are not available{#recruitment-data-are-not-available}
...
### Compute management quantities and benchmarks{#compute-management-quantities-and-benchmarks}
...
### Run stock assessment and calculate management quantities{#run-stock-assessment-and-calculate-management-quantities}
