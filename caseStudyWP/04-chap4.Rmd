...
Previous assessments have used biological benchmarks estimated for WCVI indicator stocks using an empirical relationship between watershed area and common stock-recruitment biological benchmarks, spawner abundances at replacement, S\textsubscripts{REP}, and S\textsubscripts{MSY}, from a meta-analysis of 25 Chinook stocks across North America [@parkenHabitatbasedMethodsEstimate2006]. Lack of rigorous recruitment data for WCVI Chinook stocks has precluded the use of stock-recruitment based benchmarks. 
...
<!--CH moved from intro to this section. include??-->
For the development of LRPs for WCVI Chinook, the empirical relationship between watershed area and S\textsubscripts{REP} was re-estimated using a hierarchical Bayesian model (as in @liermannUsingAccessibleWatershed2010), and applied to inlets of WCVI Chinook.  <!--CH: Add when developed (Appendix X, also link to code in Appendix \@ref(github-appendix)). 
