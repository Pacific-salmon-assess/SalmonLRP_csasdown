...
Virtually all Chinook in this SMU are 'ocean type', entering the ocean 1 to 3 months after emergence from spawning gravel [@dfoAssessmentWestCoast2012a]. 'Stream type' Chinook, those that stay in the river for one year after emergence, are rare in this SMU. After entering the ocean, WCVI Chinook generally migrate into northern BC and southeast Alaskan waters to rear for 2 to 6 years, returning to spawn predominantly at ages 3, 4 and 5 [@dfoAssessmentWestCoast2012a].
...
<!--CH fix this next pargarapph to simplify the frst sentence-->
