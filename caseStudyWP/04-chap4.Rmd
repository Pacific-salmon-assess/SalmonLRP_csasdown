...
knitr::include_graphics(here::here("figure/chinook-WCVI-inlet-timeseries-nEnh-bs.png"))
...
knitr::include_graphics(here::here("figure/chinook-RunningCorrelations.png"))
```
...
knitr::include_graphics(here::here("figure/chinook-SpawnerCorrelation.png"))
...
knitr::include_graphics(here::here("figure/chinook-compareEscCor-recCorSca.png"))
...
```{r chinook-boxplotsAge, echo=FALSE, fig.cap="Distribution of correlations of spawner abundances among inlets for observed data over the most recent 20 years (n=10 pairwise correlations) and projected time-series under the assumptions of variable age proportions among CUs and constant proportions among CUs. We assumed a cv in exploitation rates among inlets = 0.085 (half that of estimated interannual variablity in exploitation rates) in the projections.", out.width = '60%'}
 knitr::include_graphics(here::here("figure/chinook-compareEscCor-Ages.png"))
...
knitr::include_graphics(here::here("figure/chinook-baseER-ProjLRPCurve-ALLp.png"))

```

We considered sensitivity analyses on interannual variability in exploitation rates among inlets with cv = 0 and 0.17 (Figure  \@ref(fig:chinook-projLRPERs)).

```{r chinook-projLRPERs, echo=FALSE, fig.cap="Probability of all inlets being above their lower benchmark along a gradient in aggregate abundances within bins of 200 fish, derived from projections over 30 years and 50,000 MC Trials. The projections assumed variability in ERs among inlets with a cv=0, 0.085, and 0.17.", out.width = '60%'}

knitr::include_graphics(here::here("figure/chinook-cvER-ProjLRPCurve-ALLp.png"))
...
#knitr::include_graphics(here::here("figure/chinook-cvER-ProjLRPCurve-ALLp.png"))
knitr::include_graphics(here::here("figure/chinook-WCVI-SMUtimeseries.png"))
...
knitr::include_graphics(here::here("figure/chinook-Alphas-ProjLRPCurve-ALLp.png"))
...
knitr::include_graphics(here::here("figure/chinook-statusPlot-withBars2020.png"))
# add x's for years where status is not available
```
