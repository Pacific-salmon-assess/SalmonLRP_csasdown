...
The West Coast of Vancouver Island (WCVI) Chinook SMU is comprised of 3 CUs [@holtbyConservationUnitsPacific2007], 7 large inlets (or sounds), and 20 indicators stocks, which are stocks with relatively complete time-series and consistent observation methodology [Figure \@ref(fig:chinook-map), Table \@ref(tab:chinook-Overview), @riddellReview2001Chinook2002]. Hatcheries produce a relatively large component of the total production in many of these stocks, where they help achieve harvest, conservation and assessment objectives. However, they are also considered a risk factor for the long-term sustainability of CUs because they can<!--removed 'also', redundant with first also in sentence--> reduce wild genetic diversity [@withlerGeneticallyBasedTargets2018]. As described in Holt et al. (in review<!-- elsewhere this is 'in prep'-->), only indicator stocks without significant enhancement, i.e.,  stocks with Proportionate Natural Influence, PNI, values $\geqslant$ 0.5<!--suggest putting parantheses or dashes around this clause starting with i.e.--> were included. Most fish are natural origin in these populations, though the of 'wild' fish, second generation natural-origin fish may be in the minority [@withlerGeneticallyBasedTargets2018]. 
