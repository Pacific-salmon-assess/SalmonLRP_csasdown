...
**CU Status based on percentiles**
...
**Retrospective analysis of CU benchmarks based on $S_{gen}$ and percentiles** *\textcolor{cyan}{LW: Should this be included?}*
...
Using this method, 2 out of 5 CUs with data in the most recent year of data (2018) would be above their lower benchmark (amber or green zone) and 3 would be below (red zone; . 

Looking retrospectively, Georgia Strait 
...
```{r chum-perc-status-static, fig.cap="Spawner escapement (solid black line) with generational mean (4 year rolling geometric mean) of escapement in coloured points. Colours indicate status relative to percentile benchmarks. Note that for the upper three panels, the lower and upper benchmarks are both 50%, based on Holt et al. (2018).", warning=FALSE, echo=FALSE, fig.align="center"}
knitr::include_graphics('figure/fig-percentile-bm-rel-abd.png')
```
