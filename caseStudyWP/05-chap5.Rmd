...
Thus, we used 25% of spawner abundance as a benchmark for Georgia Strait, Howe Sound Burrard Inlet, 50% for Loughborough, Northeast Vancouver Island, Upper Knight, and the multidimensional approach for Bute Inlet and Southern Coastal Streams.

Caveats with benchmarks based on percentile of abundance: 

- Shifting baselines within period of data (e.g., Souther Coastal Streams)
