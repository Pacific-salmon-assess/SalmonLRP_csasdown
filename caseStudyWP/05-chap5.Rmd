...
(i) Rapid multidimesional scanning tool 
(ii) CU-level abundance relative to a lower percentile benchmark
...
<!-- KH:
I am now wondering of it makes sense to get rid of the ***Abundance-based Benchmark*** and ***MutliDim*** headers as they are kinda related.  The mutlidim uses abundance-based. 
