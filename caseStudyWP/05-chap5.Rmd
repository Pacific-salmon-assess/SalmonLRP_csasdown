...
There were several objectives of this case study:

- Apply LRP methods to a data-limited SMU
- Evaluate and compare different methods of LRP evaluation
  - Proportion-based on CU status with:
    - Percentile stutus
    - Multi-dimensional status
  - Logistic Regression based on aggregate abundance of SMU
    - Percentile status
    - Sgen status
- Evaluate differences in LRP status with variable number of CUs, years of data, and methods
