...
Comparison of CUs with regards to data/ status borrowing (Can data deficient CUs be represented by CUs with data?)

(1) Threats 

(2) Environmental Drivers (hydrology, Marine adaptive zones, BEC zones)

(3) Biological characteristics (life history, age at maturity)

(4) Habitat capacity

Burden of proof - not met, cannot infer status for Bute Inlet, Upper Knight. Also cannot infill spawning data, so these CUs are dropped for years with no spawner data. 
