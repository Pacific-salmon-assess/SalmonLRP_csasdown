...
- Sum of S\textsubscript{gen} calculated for individual rivers may not equal S\textsubscript{gen} calculated using aggregated spawner and recruit data
...
Can also bootstrap percentiles as in Peacock 2020, Holt et al. 2018


### How did using the Salmon Scanner increase the level of information used to assess SMU status compared to the single metric approach that used percentiles?
...
### How did the strategy of increasing the number of CUs included in LRP status assessment (5 CUs partial) compare to using a consistent number of CUs in all years (4 CUs full)?
...
### Why didn;t abundance-based LRPs not work for this case study
...
<!--CH: remove
    LW: I think it is an important result/point of discussion that you can have a good logistic fit up to a point and then it breaks down in subsequent years. This means that even if you have a good logistic fit and aggregate abundance LRP in year i, it could break down in the future. Maybe this could get moved somewhere else? But I think it is important. Is it covered elsewhere, eg., guidelines paper?
-->
...
CH addition:
### Status can be below LRP even as aggregate abundances increase



-------------------- Luke's original notes below here: ------------------------
...
Something about portfolio effects/ theory. Paper on Alaska shifting productivity areas from year to year. Brennan et al. 2019 
...
LW: That makes sense, I will try and find a place in Chapter 6 of Case Study paper
-->
