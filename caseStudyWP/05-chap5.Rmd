...
```{r chum-perc-status-static, fig.cap="Spawner escapement ", warning=FALSE, echo=FALSE, fig.align="center", height=8}
knitr::include_graphics('figure/fig_percentile_bm_rel_abd.png')
```

<!--
(solid black line) with generational mean (4 year rolling geometric mean) of escapement in coloured points. Colours indicate status relative to percentile benchmarks. Note that for the upper three panels, the lower and upper benchmarks are both 50%, based on Holt et al. (2018).
-->
