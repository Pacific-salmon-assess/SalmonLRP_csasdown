...
<!-- ```{r chum-map, fig.cap="Les sept unités de conservation qui composent l'unité de gestion des stocks de saumon kéta de la côte sud intérieure (à l'exclusion des unités de conservation du bas Fraser et du canyon du Fraser).", warning=FALSE, echo=FALSE, fig.align="center", out.width = '80%'} -->
