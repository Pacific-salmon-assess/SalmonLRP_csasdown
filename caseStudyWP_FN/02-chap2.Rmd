...
\multicolumn{2}{l}{PRL fondés sur l’état des UC (requis selon la \textit{Loi sur les pêches})} &  \cellcolor{gray!10}Oui &   \cellcolor{gray!10}Oui &   \cellcolor{gray!10}Oui\\
\midrule
...
\cline{2-5}
 & Projection & \cellcolor{gray!10}Yes  & \cellcolor{gray!10}Oui &  \textit{Aucune tentative, données jugées non fiables} \\
\bottomrule
\end{tabular}
(\#tab:lrpapproaches)
\end{table}
