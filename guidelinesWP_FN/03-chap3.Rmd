...
-->
L’incertitude des estimations de PRL par régression logistique peut être quantifiée au moyen d’intervalles de confiance ou de crédibilité sur l’estimation du PRL. Voir en exemple notre application au saumon coho du Fraser intérieur @holtCaseStudyApplicationsInpress.
...
De plus, comme dans le cas des PRL de régression logistique, l’incertitude structurelle de la dynamique sous-jacente de la population peut être prise en compte au moyen d’analyses de sensibilité ou de moyennes de modèles en combinant les résultats des essais aléatoires stochastiques pour ces hypothèses structurelles. Voir notre mise en œuvre pour le saumon coho du Fraser intérieur dans @holtCaseStudyApplicationsInpress pour plus de détails.
